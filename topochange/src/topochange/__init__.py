...
# Stable area analysis (requires ipyleaflet - optional dependency)
try:
    ...
    TopoMapInteractor = None
    StableAreaRasterizer = None
    StableAreaAnalyzer = None
...
__all__ = [
    ...
    # Stable areas (may be None if ipyleaflet not installed)
    "TopoMapInteractor",
    "StableAreaRasterizer",
    "StableAreaAnalyzer",
    # CRS
